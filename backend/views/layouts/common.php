        ...
        <section class="sidebar">
            ...
            echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Survivor'),
                        'url' => '#',
                        'icon' => '<i class="fa fa-users"></i>',
                        'options' => ['class' => 'treeview'],
                        'items' => [
                            ['label' => Yii::t('backend', 'Add Survivor info'), 'url' => ['/asf-survivor-info/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Manage Survivor info'), 'url' => ['/asf-survivor-info'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Add Survivor Detail'), 'url' => ['/asf-survivor-detail/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Manage Survivor Detail'), 'url' => ['/asf-survivor-detail/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Add Legal Aid Info'), 'url' => ['/asf-legal-aid/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Manage Legal Aid Info'), 'url' => ['/asf-legal-aid/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Add Medical Aid'), 'url' => ['/asf-medical-aid/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Manage Medical Aid'), 'url' => ['/asf-medical-aid/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Add Psychological Info'), 'url' => ['/asf-psychological-info/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Manage Phychological Info'), 'url' => ['/asf-psychological-info/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Add Socio Economic Info'), 'url' => ['/asf-socio-economic-info/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Manage Socio Economic Info'), 'url' => ['/asf-socio-economic-info/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Add Voilence Type'), 'url' => ['/asf-violence-type/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Manage Voilence Type'), 'url' => ['/asf-violence-type/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                        ],
...
//          
                      [
                        ...
                        'items' => [
                            ...
                            ['label' => Yii::t('backend', 'Manage Hospital'), 'url' => ['/asf-hospital/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                        ],
                        'visible' => Yii::$app->user->can('manager')
                    ],
...
//                    [
//                        'label' => Yii::t('backend', 'Apartments'),
//                        'url' => '#',
//                        'icon' => '<i class="fa fa-building"></i>',
//                        'options' => ['class' => 'treeview'],
//                        'items' => [
//                            ['label' => Yii::t('backend', 'Add Payment'), 'url' => ['/member-apartment-ledger/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
//                            ['label' => Yii::t('backend', 'Manage Payment'), 'url' => ['/member-apartment-ledger'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
//                            ['label' => Yii::t('backend', 'Add Apartment'), 'url' => ['/member-appartments/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
//                            ['label' => Yii::t('backend', 'Manage Apartments'), 'url' => ['/member-appartments/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
//                        ],
//                        'visible' => Yii::$app->user->can('manager')
//                    ],
//                    [
//                        'label' => Yii::t('backend', 'Shops'),
//                        'url' => '#',
//                        'icon' => '<i class="fa fa-building-o"></i>',
//                        'options' => ['class' => 'treeview'],
//                        'items' => [
//                            ['label' => Yii::t('backend', 'Add Payment'), 'url' => ['/member-shop-ledger/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
//                            ['label' => Yii::t('backend', 'Add Shop'), 'url' => ['/member-shops/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
//                            ['label' => Yii::t('backend', 'Manage Shops'), 'url' => ['/member-shops/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
//                        ],
//                        'visible' => Yii::$app->user->can('manager')
//                    ],
                    [
                        'label' => Yii::t('backend', 'System Users'),
                        'options' => ['class' => 'header'],
                    ...
                    [
                        ...
                        'items' => [
                           ...
                           ['label' => Yii::t('backend', 'Lookup Manager'), 'url' => ['/lookup/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            [
