...
<div class="member-appartments-form custom-box col-md-12">
    ...
    <div class="col-md-5 col-bottom-padding">
        ...
        ?>  
            ...
            echo Select2::widget([
                'model' => $model,
                'attribute' => 'plan_type',
                'options' => ['placeholder' => 'Select Installment Plane Type ...', 'id' => 'installment-type-drop'],
                'pluginOptions' => [
                    'allowClear' => true,
                    'ajax' => [
        ...
        <div class="col-md-5">
            <?php echo $form->field($model, 'prize')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-md-5">
            <?php echo $form->field($model, 'floor')->textInput(['maxlength' => true]) ?>
        </div>
    ...
    <div class="col-md-10" style="border: solid 1px #ecf0f5;margin-bottom: -10px;margin-top: 10px;">
        <div class="col-md-5">
            <?php
