...
?>
<div class="member-appartments-view">
    ...
    <p>
        ...
        ?>
    <?php if (!empty($model->apartment_document)) { ?>
            <a class="btn btn-success" href="<?= $model->photo_path ?>/<?= $model->apartment_document ?>" >Download Document</a>
    <?php } ?>
    </p>
