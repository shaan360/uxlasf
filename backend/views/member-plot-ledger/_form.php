...
<div class="member-plot-ledger-form custom-box">
    ...
    <div class="col-md-5">
        ...
        echo Select2::widget([
            'model' => $model,
            'attribute' => 'unit_id',
            'initValueText'=> common\models\MemberPlots::findOne($model->unit_id)?  common\models\MemberPlots::findOne($model->unit_id)->plot_no:"",
            'options' => ['placeholder' => 'Select Unit No ...', 'id' => 'plot_id-drop'],
            'pluginOptions' => [
                'allowClear' => true,
                'ajax' => [
                    'url' => '../member-plots/plots',
                    'dataType' => 'json',
...
<?= $form->field($model, 'payment_mode')->dropDownList(Lookup::items('payment_mode'), ['prompt' => 'Select Select']) ?>
