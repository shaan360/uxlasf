...
<div class="member-plot-ledger-form custom-box">
    ...
    <div class="col-md-5">
        ...
        echo Select2::widget([
            'model' => $model,
            'attribute' => 'appartment_id',
            'initValueText'=> common\models\MemberAppartments::findOne($model->appartment_id)? common\models\MemberAppartments::findOne($model->appartment_id)->unit_no:"",
            'options' => ['placeholder' => 'Select Apartment Number ...', 'id' => 'apartment_id-drop'],
            'pluginOptions' => [
                'allowClear' => true,
                'ajax' => [
                    'url' => '../member-appartments/apartments',
                    'dataType' => 'json',
