...
class AsfSurvivorInfo extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'attacked_age' => 'Age When attacked',
            'maturity' => 'Maturity',
            'incident_place' => 'Place of Incident',
            'incident_area' => 'Incident Area',
            'incident_province' => 'Province of Incident',
            'incident_district' => 'District of Incident',
            ...
            'survivor_address' => 'Address of Survivor',
            ...
            'literate' => 'Literate',
            'fir_date' => 'FIR Date',
            'address_province' => 'Survivor Province',
            'address_city' => 'Survivor Address',
            'address_district' => 'Survivor District',
