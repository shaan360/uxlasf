...
/**
 * MemberApartmentLedgerSearch represents the model behind the search form about `common\models\MemberApartmentLedger`.
 */
class MemberApartmentLedgerSearch extends MemberApartmentLedger
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'accountant_id', 'member_id', 'appartment_id'], 'integer'],
    ...
    {
        $query = MemberApartmentLedger::find();
