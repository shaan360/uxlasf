...
class MembersSearch extends Members
{
    ...
    public function rules()
    {
        return [
            ...
            [['membership_number', 'application_document', 'form_number', 'first_name', 'last_name', 'full_name', 'photo', 'father_husband_name', 'postal_address', 'residential_address', 'phone_office', 'phone_residential', 'mobile', 'email', 'occupation', 'nationality', 'dob', 'cnic', 'member_cnic', 'name_of_nominee', 'relation', 'address_of_nominee', 'nominee_cnic', 'nominee_cnic_scan', 'application_date', 'username', 'password', 'remarks', 'active_key', 'is_blocked', 'last_login', 'last_modified', 'timestamp', 'photo_path'], 'safe'],
        ];
    }
