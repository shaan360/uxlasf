...
class NavBar extends \yii\bootstrap\Widget
{
    ...
    public function init()
    {
        ...
        if ($this->brandLabel !== false) {
            ...
            echo "<a href='".Yii::$app->urlManagerFrontend->baseUrl."'><img style='width:120px;margin-top: 3px; margin-bottom: 5px;' src='".Yii::$app->urlManagerFrontend->baseUrl."/img/logo.png' /></a>";
